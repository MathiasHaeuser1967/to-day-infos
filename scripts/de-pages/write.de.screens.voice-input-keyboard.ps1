...
1. Öffne den Dialog **„Spracheingabe über Tastatur"** oder fokussiere das Eingabefeld und tippe auf das **Mikrofon-Icon** deiner Tastatur.  
...
|--------------|------|
| **„Titel …"** | Aufgabenname. |
| **„Beschreibung …"** | Details/Notizen (optional). |
| **„Datum …"** | Fälligkeitsdatum (optional). |
| **„Uhrzeit …"** | Startzeit (optional). |
...
| Format | Beispiel |
|--------|---------|
| **Volle Stunde** | „18 Uhr", „7 Uhr" |
| **Mit Minuten** | „18:00", „07:15" |
...
|-------------------|---------|
| „Titel Einkauf Beschreibung Milch und Brot Datum morgen Uhrzeit 18 Uhr" | Titel „Einkauf", Beschreibung „Milch und Brot", Datum = morgen, Uhrzeit 18:00. |
| „Titel Joggen Datum Mittwoch Uhrzeit 7 Uhr" | Titel „Joggen", Datum am nächsten Mittwoch, Uhrzeit 07:00. |
| „Titel Projekt-Review Uhrzeit 14:30" | Titel „Projekt-Review", Uhrzeit 14:30, Datum bleibt offen (manuell wählen). |

---

## 5) Nach dem Diktat

1. Tippe **Fertig**. Die App analysiert den Text und füllt die Felder.  
2. Prüfe die erkannten Werte kurz und **speichere** die Aktivität.  
