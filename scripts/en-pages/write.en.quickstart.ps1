...
This guide gets you going in 2–3 minutes.
...
Exclude ToDay from battery optimization (**No restrictions**) so reminders and (if available) exact alarms are triggered on time and not delayed/batched by the system.

## 4) Add your first activity
Tap **+** on **Home**, enter **Title** (required), optional **Description**, **Date** and **Time**, **Repeat** (optional), and **Reminders**. Save with **Add**.
