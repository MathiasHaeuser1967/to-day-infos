...
ToDay helps you plan and remember activities â€“ with clear lists, reminders, spoken time announcements (TTS), and optional cycles.
...
- Allow **notifications** and set **Battery optimization â†’ None** (No restrictions), so reminders aren't delayed.
...
- **Cycle planner:** plan recurring activities â†’ [Cycle planner](screens/cycle-planner.md)
- **Voice input (keyboard):** dictate text via the keyboard mic â†’ [Voice input](screens/voice-input-keyboard.md)
