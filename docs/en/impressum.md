...
## Copyright
The content and works created by the site operator are subject to German copyright law. Duplication, processing, distribution and any kind of exploitation outside the limits of copyright require the written consent of the respective author/creator. Downloads and copies of this site are only permitted for **private, nonâ€‘commercial** use.
