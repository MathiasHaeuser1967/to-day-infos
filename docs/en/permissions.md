...
Allow notifications on first launch with **Allow** â€“ otherwise Android will **not** send reminders (cycles, time announcements, alarms).

## 3) Battery optimization: â€œNo restrictionsâ€
![Battery/Energy saving â€“ No restrictions](../assets/img/de/permissions-3.png)
