...
> Note: Reminders are scheduled as notification/alarm at the chosen time (system permissions required).
...
- **Daily**  
  ...
  - **Ends**: *Endless* Â· *Until date* Â· *After count*.
- **Weekly**  
...
- "**Report**", **Monthly**: *Weekday in month -> last business day*, Remind *1 h*.
